...
// Function declarations for kernel launchers and helpers.
// These are the public-facing functions defined in flash.cpp.

void run_mha_fwd(Flash_fwd_params &params, cudaStream_t stream);
void run_mha_bwd(Flash_bwd_params &params, cudaStream_t stream);
void run_mha_fwd_combine(Flash_fwd_params &params, cudaStream_t stream, bool enable_pdl);

// Kernel template declarations
...
int round_up_headdimv(int head_size);
